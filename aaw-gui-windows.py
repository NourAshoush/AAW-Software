...
originLabel = Label(root, text="Origin File", font=("Arial", 14))
originLabel.place(x=50, y=200, width=200)

destLabel = Label(root, text="Destination File", font=("Arial", 14))
...
statusLabel = Label(root, text="", font=("Arial", 12), fg="red")
